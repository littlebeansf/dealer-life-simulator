  ...
  return (
    <div className="mb-1">
      <div className="flex justify-between items-center mb-0.5">
        <span className="text-[9px] text-muted-foreground uppercase tracking-wider" style={{ fontFamily: 'Press Start 2P, monospace' }}>{label}</span>
        {showValue && <span className="text-[9px] text-foreground" style={{ fontFamily: 'Press Start 2P, monospace' }}>{Math.round(value)}</span>}
      </div>
